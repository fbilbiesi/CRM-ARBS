...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:1234@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:1234@localhost:3306/gocrm?new_link=true');
  }
}
...
$civicrm_root = 'C:/Apache24/htdocs/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/Apache24/htdocs/drupal\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '726d30a6803c61d123911573839af208');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/Apache24/htdocs/drupal\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
